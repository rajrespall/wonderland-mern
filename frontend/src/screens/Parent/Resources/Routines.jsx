        ...
        <Container maxWidth="lg" sx={{ flex: 1, py: { xs: 4, md: 6 } }}>
          <Fade in={true} timeout={800}>
            <Box sx={{ mt: 2, mb: 6 }}>
              ...
              >
                Discover expert-curated resources designed to help establish effective routines and create structure in your child's daily life.
              </Typography>
                    ...
                    <Card sx={{
                      ...
                      <CardContent sx={{ p: 4, flexGrow: 1 }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                          <AccessTimeIcon sx={{ color: '#0457a4', mr: 2 }} />
                          <Typography
                            variant="h5"
                            sx={{ 
                              fontWeight: 600,
